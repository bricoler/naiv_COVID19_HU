...
BE <- na.omit(as.numeric(covid_eu["Belgium",]))
...
plot(pnap, HU_pmaxi[1:kir], xlab = "Napok, 2020.03.10 - 2020.04.10", ylab = "Igazolt fertőzött betegek száma", col=8, lty = 2, pch = 16, cex=0, log="y")
...
lines(pnap[1:kir], HU_pi[1:kir], type="b")
